let dados = [
    {
        titulo : "Biografia",
        descricao : "Apaixonado por tecnologia e constantemente em busca de novos conhecimentos, estou atualmente desenvolvendo um site de teste para praticar e aprimorar as habilidades adquiridas no curso de Tecnologia da Informação.",
        link : "https://www.linkedin.com/in/davissxavier/"
    }, 
    {
    ...
    {
        titulo : "Contato",
        descricao : "Se você não está familiarizado com o Git, mas gostaria de compartilhar sua opinião, fazer um elogio, ou entrar em contato por qualquer motivo (parceria, encontro, ou apenas testes), clique no link para acessar o meu formulário.",
        link : "https://docs.google.com/forms/d/e/1FAIpQLSes2leFtJYoQl27JLNvGJuZ1pTRk1_Ff8iAMpWxWCh6vO7lPA/viewform?usp=sf_link",
    }
]